...
{
    public partial class view_Rrequest : System.Web.UI.Page
    {
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["db1ConnectionString"].ConnectionString);
            con.Open();
            SqlCommand cmd = new SqlCommand("UPDATE [Repair_Request] SET amount_actual=@amt where (Rr_Id=@rrid)", con);
            cmd.Parameters.AddWithValue("rrid", Convert.ToInt16(Label1.Text));
            cmd.Parameters.AddWithValue("amt",txt_amt_act.Text);
